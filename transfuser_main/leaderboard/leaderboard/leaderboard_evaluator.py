...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config,data_folder,route_folder,k,model_path,fault_type,image_folder,sensor_faults_file):
        """
        ...
        self.manager.run_scenario(distance_path)
    ...
    def run(self, path,args,data_folder,route_folder,model_path,image_folder):
        ...
        while route_indexer.peek():
            ...
            self._load_and_run_scenario(args,config,data_folder,route_folder,k,model_path,fault_type,image_folder,sensor_faults_file)
