...
class StatisticsManager(object):
    ...
    def save_global_record(route_record, sensors, endpoint,filename,stats_file,config):
        ...
        collision = stats_dict['infractions']['collisions_vehicle'] + stats_dict['infractions']['collisions_pedestrian']
        Infractions = stats_dict['infractions']['red_light']  + stats_dict['infractions']['stop_infraction']
        out_of_lane = stats_dict['infractions']['outside_route_lanes']


        myvalues = [{'avg. route score': '{:.3f}'.format(stats_dict['scores']['score_route']),
                    'collision':collision, 'route_deviation':'{:.3f}'.format(stats_dict['infractions']['outside_route_lanes']),
        ...
        return collision, Infractions, out_of_lane 
