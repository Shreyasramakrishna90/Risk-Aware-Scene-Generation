...
class RouteIndexer():
    def __init__(self, routes_file, scenarios_file, repetitions,data_folder):
        ...
        # retrieve routes
        #route_descriptions_list = RouteParser.parse_routes_file(self._routes_file,self.xml_folder, False)
        route_descriptions_list = RouteParser.parse_routes_file1(self._routes_file,self.xml_folder, False)
