...
class RouteParser(object):
    ...
    @staticmethod
    def parse_routes_file(route_filename,xml_folder, single_route=None): #This has been updated for our experiments
        """
    ...
    @staticmethod
    def parse_routes_file1(route_filename,xml_folder, single_route=None):
        """
        Returns a list of route elements that is where the challenge is going to happen.
        :param route_filename: the path to a set of routes.
        :param single_route: If set, only this route shall be returned
