...
if __name__ == "__main__":
    DATA_DIR = "/isis/Carla/old/simulation3"

    description = "calculate stats for resonate\n"

    parser = argparse.ArgumentParser(description=description, formatter_class=RawTextHelpFormatter)
    parser.add_argument("path", help="specify the location of the data to run analysis on", type=str, default="/isis/Carla/old/simulation3")
